...
import { pageAtom, pages } from "./BookUI";
...
pages.forEach((page) => {
  // Determine extension: page1 is .jpg, page2-5 are .png, others are .jpg
  const getExt = (name) => {
    if (name === 'page1') return '.jpg';
    if (name.startsWith('page')) return '.png';
    return '.jpg';
  };
...
const Page = ({ number, front, back, page, opened, bookClosed, ...props }) => {
  // Determine file extension: page1 is .jpg, page2-5 are .png, others are .jpg
  const getExt = (name) => {
    if (name === 'page1') return '.jpg';
    if (name.startsWith('page')) return '.png';
    return '.jpg';
